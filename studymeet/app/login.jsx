        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.container}>
            ...
            <View style={styles.formContainer}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.subtitle}>Inicia sesión para retomar el estudio</Text>
                </View>
                ...
                <TouchableOpacity style={styles.primaryButton} onPress={handleLogin}>
                    <Text style={styles.primaryButtonText}>Entrar a tu cuenta</Text>
                    <Ionicons name="arrow-forward" size={18} color="#FFFFFF" style={{ marginLeft: 8 }} />
                </TouchableOpacity>

                <TouchableOpacity onPress={() => router.push('/register')} style={styles.linkContainer}>
                    <Text style={styles.linkBaseText}>¿No tienes cuenta? <Text style={styles.linkText}>Regístrate gratis</Text></Text>
                </TouchableOpacity>
            </View>
...
const styles = StyleSheet.create({
    ...
    iconWrapper: { backgroundColor: '#EEF2FF', padding: 16, borderRadius: 24, marginBottom: 24 },
    ...
    primaryButton: { flexDirection: 'row', backgroundColor: '#4F46E5', padding: 18, borderRadius: 20, alignItems: 'center', justifyContent: 'center', marginTop: 16, shadowColor: '#4F46E5', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.3, shadowRadius: 16, elevation: 6 },
